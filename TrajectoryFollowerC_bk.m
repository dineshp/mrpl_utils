classdef TrajectoryFollowerC
    ...
    methods(Access = public)  
        ...
        function poseArray = executeTrajectory(obj, robot)            
            curve = obj.curve;
            ...
            while((t(i) <= (t_f)))              
                ...
                if(firstIteration == false)               
                    ...
                    p_i_ref = curve.getPoseAtTime(t(i));
                    %get velocity from open loop 
                    u_ref_V = curve.getVAtTime(t(i));
                    u_ref_w = curve.getwAtTime(t(i));
