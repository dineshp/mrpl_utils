...
%   USA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 %load model, load image, calculate H, save image
...
title_figure = 'Neato Robot';

cell_list{1,1} = {'Localize','disp(''here'');'};
cell_list{1,2} = {'Find Sail','loading_calib;'};
cell_list{2,1} = {'Drive to Sail/Pick Up','disp(''here'');'};
cell_list{2,2} = {'Back up/Turn around',['clear; disp(''Bye. To run again, type ocam_calib.''); close(' num2str(fig_number) ');']}; %{'Exit','calib_gui;'};
