classdef TrajectoryFollowerDs
    ...
    methods(Access = public)  
        function obj = TrajectoryFollowerDs(curve, enableFeedback)
            %constructor  
        ...
        function executeTrajectory(obj, robot)            
            ...
            while(((s(i)) <= s_f))              
                ...
                if(firstIteration == false)               
                    ...
                    % 4. UPDATE CONTROL
                    p_i_ref = curve.getPoseAtTime(curve.getTimeAtDist(s(i)));

                    %get velocity from open loop 
                    u_ref_V = curve.getVAtDist(s(i));
                    u_ref_w = curve.getwAtDist(s(i));
